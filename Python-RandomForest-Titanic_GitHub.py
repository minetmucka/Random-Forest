...
#Data Source: Titanic                                                       #
#Python Version: 3.4+                                                       #
#Using Packages: scikit-learn, pandas, numpy, sklearn-pandas, matplotlib    #
#############################################################################
...
titanic = pd.read_csv('C://Users//muckam//Desktop//DataScienceBootcamp//Datasets//titanic.csv')
...
# Feature Importance. We binarized the categorical columns, so there are 12 numbers.
