#########################################################################################################################################
## Objective: Extracting Titles Feature Engineering from Titanic Dataset                                                                #
## Data source: titanic data set                                                                                                        #
## Please install "stringr" package: install.packages("stringr") for working with strings, data cleaning and prep                       #
## Please install "randomForest" package: install.packages("randomForest") for RF                                                       #
#########################################################################################################################################


setwd("C:/Users/muckam/Desktop/DataScienceBootcamp/Datasets")
...
# Creates a new data frame with survive with titles
